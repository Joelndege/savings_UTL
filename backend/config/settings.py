...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-fp^=p(7h+-$e!$v8!9n3!w@y6(!!x*9!7)@y$@#*8$#*8!9!'
)
...
# Falls back to SQLite for quick local dev if PG is not configured
DATABASES = {
    'default': {
        'ENGINE': os.environ.get('DB_ENGINE', 'django.db.backends.postgresql'),
        'NAME': os.environ.get('DB_NAME', 'savings_utl'),
